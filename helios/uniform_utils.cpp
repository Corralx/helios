...
static std::vector<std::string> default_uniforms =
{
	...
	"__hl_shadow_quality",
	"__hl_shadow_epsilon",
	"__hl_shadow_starting_step",
	"__hl_shadow_max_step",
	"__hl_enable_ambient_occlusion",
	"__hl_ambient_occlusion_step",
	"__hl_ambient_occlusion_iterations",
	"screen_width",
	"screen_height",
	"__hl_floor_height",
	"__hl_sky_color",
	"__hl_light_direction",
	"__hl_light_color",
	"__hl_camera_position",
	"__hl_camera_view",
	"__hl_camera_up",
	"__hl_camera_right",
	"__hl_focal_length",
